...
#ifndef FIRSTDRAFT_FILENODE_H
#define FIRSTDRAFT_FILENODE_H
...
public:
    ...
    FileNode();
    FileNode(Image icon, std::string text, sf::Vector2f size, sf::Vector2f position);
    ...
    void addChild(Image icon, std::string label);
    bool isClicked();
};


#endif //FIRSTDRAFT_FILENODE_H
